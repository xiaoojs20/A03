...
class Post(models.Model):
    ...
    picture_1 = models.ImageField(null=True, blank=True, verbose_name='帖子图片1')
    picture_2 = models.ImageField(null=True, blank=True, verbose_name='帖子图片2')
    picture_3 = models.ImageField(null=True, blank=True, verbose_name='帖子图片3')
    picture_4 = models.ImageField(null=True, blank=True, verbose_name='帖子图片4')
    picture_5 = models.ImageField(null=True, blank=True, verbose_name='帖子图片5')
    picture_6 = models.ImageField(null=True, blank=True, verbose_name='帖子图片6')
    picture_7 = models.ImageField(null=True, blank=True, verbose_name='帖子图片7')
    picture_8 = models.ImageField(null=True, blank=True, verbose_name='帖子图片8')
    picture_9 = models.ImageField(null=True, blank=True, verbose_name='帖子图片9')
